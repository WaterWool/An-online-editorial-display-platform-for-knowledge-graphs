import { computed, createApp, defineComponent, getCurrentInstance, onMounted, onBeforeUnmount, PropType, reactive, ref, provide, inject, withCtx } from "vue";
    ...
    setup(props, ctx) {
        ...
        return () => (
            <div class="dropdown-option" onClick={handler.onClick}>
                ...
                <span>{props.label}<span>{props.tip}</span></span>
